...
* [SAP Applications on Microsoft Azure using Azure NetApp Files][anf-sap-applications-azure]
...
3. **[A]** Prepare the OS for running SAP HANA on Azure NetApp with NFS, as described in [SAP Applications on Microsoft Azure using Azure NetApp Files][anf-sap-applications-azure]. Create configuration file */etc/sysctl.d/netapp-hana.conf* for the Azure NetApp Files configuration settings.  
...
5. **[A]** Adjust the sunrpc settings, as recommended in [SAP Applications on Microsoft Azure using Azure NetApp Files][anf-sap-applications-azure].  
...
6. To optimize SAP HANA for the underlying Azure NetApp Files storage, set the following SAP HANA parameters:
   ...
   For more information, see [SAP Applications on Microsoft Azure using Azure NetApp Files][anf-sap-applications-azure]. 
